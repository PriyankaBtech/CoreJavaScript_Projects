...
let topicList = document.getElementById('topic-list') // add in global, for give excess mutltiple place
...
addBtn.addEventListener('click', (e) => { // function for add value
    ...
    createList.innerHTML = `<h3>${currentList}</h3><div>
                        <button class="btn btn-edit" onclick="editTopic(this)">Edit</button>
